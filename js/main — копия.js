let  offerFavorit = document.querySelector('.offer-favorit');
...
class Joke{
  ...
  addToFavourite(favourite){
    ...
    let jokeBlock = document.querySelector(`#${this.id} .favourite`);//button
    ...
    let getCurrentJoke = jokes.filter((joke)=>joke.id !== this.id);
      ...
      offerFavorit.style.display = 'none';
      jokeDiv.style.maxWidth =' 960px';
